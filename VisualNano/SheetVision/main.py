...
# Because we are running from the directory VisualNano
sys.path.append("SheetVision/")
...
staff_files = [
    "SheetVision/resources/template/staff2.png", 
    "SheetVision/resources/template/staff.png"]
quarter_files = [
...
staff_lower, staff_upper, staff_thresh = 50, 150, 0.7
sharp_lower, sharp_upper, sharp_thresh = 50, 150, 0.7
flat_lower, flat_upper, flat_thresh = 50, 150, 0.7
quarter_lower, quarter_upper, quarter_thresh = 50, 150, 0.8
half_lower, half_upper, half_thresh = 50, 150, 0.8
whole_lower, whole_upper, whole_thresh = 50, 150, 0.8
...
def sheetvisionMain(img_file):
    ...
    midi_filename, _ = os.path.splitext(img_file)
    midi_filename += ".mid"
